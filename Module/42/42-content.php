...
<div class="type-42">
    <div class="content">
        <div class="background">
            <h1 class="qodef-st-title" style="color: #ffffff">pages for all uses </h1>
            <h5>We covered every bit and piece your new website is going to need – WaveRide comes with a great collection of diverse predesigned inner page templates.</h5>
        </div>
        <div class="rs-loop">
            <p>awesome event</p> 
            <p>timetables.</p>
