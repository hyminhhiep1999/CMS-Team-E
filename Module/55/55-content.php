			...
			<div class="col-md-6">
				...
				<div class="row 2 text-1">	
					...
					<div class="col-md-3">
						<div class="text-2">
							<span>+15</span>
							<img src="https://waveride.qodeinteractive.com/wp-content/themes/waveride/assets/img/sunny.png" alt="">
						</div>
					</div>
					<div class="col-md-3">
						<div class="text-1">
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="img-her">
							<img src="./images/55-1.jpg" alt="a">
						</div>	
					</div>
					<div class="col-md-6">
						<div class="world">
							<img src="./images/55-2.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="space">
