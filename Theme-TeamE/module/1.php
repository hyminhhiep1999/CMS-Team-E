    ...
    <div class="type-1">
            <header class="header-wave">         
                <div class="navbar-custom d-flex align-items-center">
                    <h1 class="logo mr-auto"><img src="<?php bloginfo("template_directory"); ?>/images/logo.png" alt="Logo"></h1>
                    <h1 class="logo2 mr-auto"><img src="<?php bloginfo("template_directory"); ?>/images/logo2.png" alt="Logo"></h1>
                    <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        <li class="drop-down active">
                            <a href="#"> <img src="<?php bloginfo("template_directory"); ?>/images/icon.png" alt="ICon"> Home</a>
                            <ul class="ul-icon">
                                <li><a href="<?php echo get_site_url() ?>">Surfing Home</a></li>
                                <li class="active"><a href="<?php echo get_site_url() ?>">Shop Home</a></li>
                                <li><a href="<?php echo get_site_url() ?>">Yatching Home</a></li>
                                <li><a href="<?php echo get_site_url() ?>">Caneoing Home</a></li>
                            </ul>
                        </li>
                        <li class="drop-down">
                            <a href="#">Pages</a>
